...
/*
VET1[SCHEDINA] Schedina da 15 x8 giocatori in cui saranno memorizzati a Random secondo una particolissima procedura e ordinati attraverso Bubble Sort
GIOC1[SCHEDINA] Schedina giocatore a 15 da visualizzare  
...
*/
	...
	int GIOC1[SCHEDINA], GIOC2[SCHEDINA], GIOC3[SCHEDINA], GIOC4[SCHEDINA], GIOC5[SCHEDINA], GIOC6[SCHEDINA]; 
	int  i, indice1, indice2, indice3, indice4, indice5, indice6, gestnum, gestnvcol, c, contsom, trovato, numerorandom, Ordinato, comodo, Scan, ordin;
	int col, riga, gestsched, scelta1,  tempo, color, cortemp, corcolor, avv, cor2color, cor2temp, NumeroGiocatori, a, Ii, Ng, sceltaSchedina;
...
//*******************ORDINAMENTO VET8*************************************************************************************************************************************
						...
						do{
						textcolor(12);
						gotoxy(2,1); printf("GIOCATORE %d: Scegli la schedina fortunata --> . (Premi '0' per aggiornare)",Ng+1);
						gotoxy(48,1); scanf("%d", &sceltaSchedina);
						}while(sceltaSchedina<0 || sceltaSchedina>8);
			
						textcolor(7);

				
				switch(sceltaSchedina)   //I numeri delle schedine scelte vengono copiati nel Grande Vettore SCHEDEGIOC
				{
				...
				}while(sceltaSchedina==0);    //se viene schiacciato 0 aggiornerà le schede
...
/////////////////////riga orizzontale in centro dello schermo
    ...
    do{
    	...
    	col++;
							...
							gotoxy(42,3); printf("GIOCATORE 2");
...
//	                                                    CROCE (a 4)
	 ...
	 do{
	 	...
	 	col++;
							...
							gotoxy(2,17); printf("GIOCATORE 2");
							...
							gotoxy(2,31); printf("GIOCATORE 3");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////						
				...
				}//CHIUSURA SWITCH (NumeroGiocatori)

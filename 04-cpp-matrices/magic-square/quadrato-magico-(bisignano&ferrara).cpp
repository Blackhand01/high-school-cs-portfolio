//Stefano Roy Bisignano & Giovambattista Ferrara
...
int main()
{
	...
	do{
		...
		do{
			...
			if((l%2)==0 || l>19 || l<3)
			{
				textcolor(12);	gotoxy(30,9);	printf("Attenzione!!!");
				textcolor(15);	gotoxy(4,10);	printf("Devi inserire un valore dispari minore di 19 e maggiore di 1!");
				getch();
			}
		}while((l%2)==0 || l>19 || l<3);			//il numero non può essere né pari né minore di 3 né maggiore di 19
	...
	system("CLS");
	textcolor(12);	gotoxy(7,3);	printf("Ci si rivede!!!\n\n");	textcolor(7);
}
...
if(corn==1)	{cortemp=0;}	else	{cortemp=25;}	//////comandi per cambiare il tempo della schermata home da quella delle altre scheramte (schermata home è più lenta)
